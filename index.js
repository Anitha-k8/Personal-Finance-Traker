...
function calculateSavings() {
    ...
    savingsSummary.textContent = `Total Income: ${totalIncome.toFixed(0)}, Total Expenses: ${totalExpenses.toFixed(0)}, Savings: ${savings.toFixed(0)}`; // Fixed string interpolation
}
...
setBudgetButton.addEventListener('click', () => {
    ...
    budgetStatus.textContent = `Monthly Budget Set: ${monthlyBudget}`; // Fixed string interpolation
    checkBudget();
});
